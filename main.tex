...
The idea of our \improved{algorithm for explicit construction of a basis}\footnote{Here we are decribing an algorithm to *compute* (a basis of) this lattice. Constructing suggest } is to compute a basis of the dual lattice first.
...
\textcolor{red}{ToDo}: Describe shortly the step 1
...
\]
\end{definition}
\textcolor{red}{ToDo}: Prove it's a lattice, prove that its basis is the concatenation
