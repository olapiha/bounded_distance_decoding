...
The idea of our \toimprove{construction}\footnote{Here we are decribing an algorithm to *compute* (a basis of) this lattice. Constructing suggest } algorithm is to compute basis of the dual lattice first. %using the fact that the dual of an intersection is union of the duals and also that %parity check representation of the lattice gives us generating set of the dual.
