...
Our algorithm allows to decode errors of both signs efficiently, so adding it will improve security of [LLXY17] encyption scheme. Let us estimate how resistant is the scheme agains our most efficient attack when it uses $ e \in \{0,1\}^{n}$ and $ e \in \{0,1,-1\}^{n}$ of the same $l_1$ norm. The costs and improvement are presented in the following table.\\
\begin{tabular}{ |l||p{2,4cm}|p{2,4cm}|p{2,4cm}|p{2,4cm}|p{2cm}|  }
 \hline
 ...
 \hline
 Ternary & 3.91124e+103 & 8.987320e+68 & 1.094713e+54 & 3.432411e+46 & $2^{18}$ \\
 \hline
\end{tabular}
